...
class QuarryDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let titleAttributes = [NSFontAttributeName:UIFont(name: "HelveticaNeue-Bold", size: 17.0)!, NSForegroundColorAttributeName:UIColor.yellow]
        let paragraphStyle = NSMutableParagraphStyle()
        paragraphStyle.alignment = NSTextAlignment.center
        
        let centerAttributes = [NSFontAttributeName:UIFont(name: "HelveticaNeue-Bold", size: 17.0)!, NSForegroundColorAttributeName:UIColor.yellow,NSParagraphStyleAttributeName:paragraphStyle]
        
        let bodyAttributes = [NSFontAttributeName: UIFont(name: "HelveticaNeue", size: 17.0)!, NSForegroundColorAttributeName: UIColor.yellow]
        ...
        if self.title == "Have a meeting" {
            ...
            let controller1 = self.storyboard?.instantiateViewController(withIdentifier: "QuarryPageContentDetailViewController") as! QuarryPageContentDetailViewController
            
            let myAttributedMeetingString1 = NSMutableAttributedString()
            
            myAttributedMeetingString1.append(NSAttributedString(string:"\n• Research\n\n• Personal biography\n\n• Organisation structure\n\n• Client strategic objectives\n\n• Decision network\n\n• Competitor presence\n\n• Pain points\n\n• Hypotheses on pain points\n\n• Script the meeting\n\n• Identify the what we finds\n\n• Understand the time agreement\n\n• Secretary’s name.\n\n", attributes: bodyAttributes))
            ...
            if self.titleLabelText == "ROVA" {
                ...
                myAttributedROVAString.append(NSAttributedString(string:"\nEvery encounter you have with your client should cover ALL of the four below:\n\n",attributes: titleAttributes))
                
                myAttributedROVAString.append(NSAttributedString(string:"Relationship: ",attributes:titleAttributes ))
                myAttributedROVAString.append(NSAttributedString(string:"Ensure you build upon your relationship with the client at every opportunity, show that you care through getting to know them.\n\n", attributes: bodyAttributes))
                myAttributedROVAString.append(NSAttributedString(string:"Opportunity: ",attributes:titleAttributes ))
                myAttributedROVAString.append(NSAttributedString(string:"This is a business relationship, so opportunities to work together should always be on the agenda, so look out for them and take note.\n\n",attributes:bodyAttributes ))
                myAttributedROVAString.append(NSAttributedString(string:"Value: ",attributes:titleAttributes ))
                myAttributedROVAString.append(NSAttributedString(string:"Always add value to the client on every encounter, however small. The client should leave the encounter richer.\n\n",attributes:bodyAttributes ))
                
                myAttributedROVAString.append(NSAttributedString(string:"Agreement: ",attributes:titleAttributes ))
                myAttributedROVAString.append(NSAttributedString(string:"Ensure that you make agreements however small or trivial and always follow through on the agreements.",attributes:bodyAttributes ))
            ...
            if self.titleLabelText == "What We Find"{
                ...
                myAttributedROVAString.append(NSAttributedString(string:"\nTell the story: \n\n",attributes:titleAttributes ))
                myAttributedROVAString.append(NSAttributedString(string:"• When we worked with…\n\n• They were facing … challenge\n\n• They new that…\n\n• (We conducted a …)\n\n• What we found was …\n\n• We launched a programme to …\n\n• The impact/ benefit was …\n\n", attributes: bodyAttributes))
