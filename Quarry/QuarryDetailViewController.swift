...
class QuarryDetailViewController: UIViewController {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        controller1.title = "MUSIC"
        //controller1.detailTextContent = detailText
        controllerArray.append(controller1)
        
        let controller2 : TestViewController = TestViewController(nibName: "TestViewController", bundle: nil)
        controller2.title = "MUSIC"
        //controller2.detailTextContent = detailText
